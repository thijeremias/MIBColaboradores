...
def consultar(request):
	...
	if request.method == 'POST':
		...
		var = Colaborador.objects.#Função que retorna o nome do colaborador(request.POST.get('colaborador_nome')).filter(colaborador_franquia = a).order_by('colaborador_nome')
